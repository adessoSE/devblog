...
Auf GitHub, GitLab und ähnlichen Plattformen zur Veröffentlichung von Sourcecode wird in nahezu jedem Repository auf eine Lizenz hingewiesen. Aber um Open-Source-Code zu verwenden brauche ich doch keine Lizenzgebühren zahlen und darf den Code verwenden wie ich möchte, oder? Leider nein. Zwischen den einzelnen Lizenzen gibt es einige Unterschiede. Dieser Blogpost soll dabei helfen, die richtige Lizenz für das eigene Projekt zu finden und Projekte von Anderen richtig zu verwenden.
...
Mit der Veränderung oder Verteilung des Codes unter der GPL erfolgt eine automatische Zustimmung zu den Bedingunge dieser Lizenz. Bei Verstößen gegen diese Lizenz erlischen alle Rechte, die diese Lizenz im Bezug auf den betreffenden Code gewährt.
...
- Es ist nicht notwendig, die GPLv3 für das alleinige Besitzen einer Kopie des unter der GPLv3 stehenden Werkes zu akzeptieren. Das Bearbeiten oder Verteilen erfordert aber das Akzeptieren der Lizenz.
...
Änderungen an einem Werk unter der Apache License müssen nicht zwangläufig unter der Apache License veröffentlicht werden, allerdings müssen die Rechte und Pflichten der dann verwendeten Lizenz mit denen aus der Apache License übereinstimmen. Dies muss eindeutig kenntlich gemacht werden. Geschieht dies nicht, gilt die Apache License.
...
Eine Besonderheit ist, dass jede Rechtsstreitigkeit, an der eine Partei aus einem EU-Mitgliedsland beteiligt ist, der Zustädnigkeit der Europäischen Gerichtshifs unterliegt. Alle anderen Rechtsstreitigkeiten unterliegen der Zuständigkeit des Gerichts in dem der Lizenzgeber wohnt oder sein Hauptgeschäft betreibt.
