...
Zu jedem Wissenschaflter speichern wir, _Id, Name, Vorname, Telefonnummer_ und _Auszeichnungen_.
...
**(B)** Wenn wir uns dazu entschieden haben, die Wissenschaflter nach Nachnamen zu sortieren, gibt es das nächste Problem, wenn es um das Hinzufügen neuer Einträge geht. 
...
Es muss jeder Eintrag der Liste untersucht werden und innerhalb jedes Eintrages die Lsite von Preisen vollständig durchlaufen werden, um zu prüfen, ob der Nobelpreis vergeben wurde.
...
Daten in einer relationalen Datenbank werden in mehreren Tabellen, sogenannten **Relationen**, abgelegt.
...
Die tatsächliche Reihenfolge, in der sich die Einträge auf der Festplatte befinden, spielt dadurch (in diesem Fall) keinerlei Rolle mehr.
