...
In meinem vorhergehenden Blog-Beitrag habe ich die [Gründe und 6 Strategien für die Migration einer Applikation in die Cloud aufgezeigt](https://www.adesso.de/de/news/blog/gruende-und-strategien-fuer-die-migration-einer-applikation-in-die-cloud.jsp).
...
![Kosten und Nutzen der Rearchitecting Strategie im Vergleich](/assets/images/posts/cloud-native-migration-mit-der-rearchitecting-strategie/rearchitecting_efficency.png) 
...
Die Cloud Anbieter bieten verschiedene Container Ausführungsumgebungen. 
...
Für statischen Webcontent bieten die Cloud Anbieter spezialisierte und kostengünstige Services an.
...
Die Anwendung sollte in Microservices aufgeteilt werden, falls noch nicht geschehen. Innerhalb der Microservices sollte geprüft werden, ob einzelne Funktionen der Anwendung als Serverless Functions bzw. Functions as a Service (FaaS) ausgelagert werden können.  
...
Der Erkennung von Fehlern wird von den Logging und Alerting Diensten der Cloud Anbieter unterstützt.  
Datensicherung, Datenversionierung und Rollbacks sind einfach zu konfigurieren.
Durch die automatische Skalierung ist die Performanz der Anwendung jederzeit sichergestellt. Die Auslagerung der statischen Webseiten in Kombination mit dem CDN sorgt für niedrigste Latenzen.
...
Durch den Einsatz von Cloud native Services verstärkt sich der Vender Lockin. Die Anwendung ist nach der Refactoring Strategie stärker abhängig vom jeweiligen Cloud Anbieter.
Diesen Vendor Lockin geht man letztlich mit jeder Technologie Entscheidung ein. 
Zu vielen Services gibt es ein entsprechendes Pendant bei den anderen Cloud Anbietern, wodurch auch ein Wechsel zwischen den Cloud Anbietern im Fall der Fälle machbar ist.
...
Es gibt diverse Plugins für Entwicklungsumgebungen, die die effiziente Entwicklung, das Deployment und das Debuggen von Cloud Anwendungen ermöglichen, bspw. [AWS Toolkits](https://aws.amazon.com/de/tools/) 
