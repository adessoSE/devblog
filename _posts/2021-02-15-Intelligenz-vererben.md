...
Beispielsweise Datensätze von Millionen von Bildern, die angeben, um was es sich handelt (Lebewesen, Dinge des Alltags, Zahlen oder Buchstaben).
...
Auf der anderen Seite muss aber im Vorfeld und bei der Entwicklung der Algorithmen und des Models genau überlegt werden, welche Informationen bereitgestellt werden müssen, damit sich die Gene und damit das Neuronale Netz verbessert.
