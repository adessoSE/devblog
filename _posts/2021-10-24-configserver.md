...
Denn wir müssen nicht nur die Kosten betrachten, die durch den Betrieb der Hardware entstehen, sondern müssen auch die Aufwände berücksichtigen, die uns bei selbst gehosteten Lösungen immer wieder durch Updates entstehen.
Und dabei sind nicht nur die jeweils aktuellsten und sichersten Versionen der eingesetzen Software zu betrachten, sondern auch die Deployment-Scripte, wie zum Beispiel Helm, oder auch eventuell benötigte Versionen von Terraform, die stetigen Aktualisierungen unterliegen.
